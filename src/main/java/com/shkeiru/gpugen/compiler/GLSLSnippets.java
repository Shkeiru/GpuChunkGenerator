...
public class GLSLSnippets {
    ...
    public static String getComputeHeaderAndNoiseBase() {
        ...
        for (int i = 1; i <= 16; i++) {
            ...
            sb.append("    float current_amp = 1.0;\n");
            sb.append("    for (int i = 0; i < ").append(i).append("; i++) {\n");
            sb.append("        if (amps[i] != 0.0) {\n");
            sb.append("            first_val += amps[i] * current_amp * sample_improved_noise(first_pos, offset1 + i);\n");
            sb.append("            second_val += amps[i] * current_amp * sample_improved_noise(second_pos, offset2 + i);\n");
            sb.append("        }\n");
            sb.append("        first_pos *= 2.0;\n");
            sb.append("        second_pos *= 2.0;\n");
            sb.append("        current_amp /= 2.0;\n");
            sb.append("    }\n");
